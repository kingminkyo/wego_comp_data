...
class lidar():
    ...
    def Ego_topic_callback(self, data):
        ...
        try:
            ...
            # 3. 라바콘                               # 라바콘을 가장 먼저 걸러내야한다.
                ...
                # 무슨 미션인지를 판정을 먼저 해야한다.
                    ...
                    if (   (   (-5 < now_hd and now_hd < 5) or (85 < now_hd and now_hd < 95)   )    or (-85 > now_hd and now_hd > -95)   )   or   (175 < now_hd or now_hd < -175):
                        ...
                        #                      동적 장애물 미션에서 거의 다 1.5에서 커트가 난다.  사실 거의 1.5이상이다...
                        # elif self.nearest_length < 1.2:
                        #     print("*******정적장애물 미션*******")
                        #     print(self.nearest_length, "튜닝", self.nearest_idx)
                        #     self.mission_mode = 3
            ...
            # 동적 장애물 미션
                ...
                # print(self.nearest_idx, self.nearest_length)
                self.screen = 0
                self.moving_obs()
    ...
    def lidar_callback(self, data):
        # print(data.ranges[0],"asdfasdfasdfasdfs")
        # print(data.ranges[330:360])
        ...
        for i in range(270,450):
            ...
            if start == 1:
                ...
                if abs(reference - data.ranges[i]) < 0.05:
                    ...
                    # 값이 너무 제대로 안나와서 2개만나와도 바로 물체로 해주기!!
    ...
    def moving_obs(self):
        ...
        # 기존까
        # elif self.check == 0 or ((353 <= self.nearest_idx or self.nearest_idx < 18) and self.nearest_length < 1):
        #     if self.boigisick == 0:
        #         print("정지시작!!!!!")
        #         # print(self.nearest_idx, self.nearest_length)
        #         self.boigisick = 1
